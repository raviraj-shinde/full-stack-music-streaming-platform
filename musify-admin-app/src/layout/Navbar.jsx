...
const Navbar = ({ activeMenu }) => {
  ...
  return (
    <div className="flex items-center justify-between gap-5 bg-white border border-b border-gray-200 backdrop-blur-[2px] py-4 px-7 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span className="hidden sm:inline text-sm font-medium cursor-pointer">Logout</span>
        </button>
      </div>
